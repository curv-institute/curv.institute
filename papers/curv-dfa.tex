...
When geometry curvature control and SCC are applied simultaneously, deviations from additivity remain below 2\% across all test systems (measured with the SCC v1 implementation; regeneration with SCC v2 is pending), demonstrating orthogonality and composability of the control channels.
